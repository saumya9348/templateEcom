...
<div class="container toparea">
	<div class="underlined-title">
		<div class="editContent">
			<h1 class="text-center latestitems">Change Password</h1>
		</div>
    ...
    <div class="sign_in">
		...
		?>
			<h4 style="color:red;"><?php echo $_SESSION['pwreset']; unset($_SESSION['pwreset']); ?></h4><br>
		<?php } ?>
            <form action="change_pw_code.php" method="post">
                <div class="form-group">
                    <label for="exampleInputEmail1">Old Password</label>
                    <input type="" class="form-control" id="exampleInputEmail1" aria-describedby="" name="oldpw" placeholder="enter old password" required>
                    <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">New Password</label>
                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="new Password" name="newpw" required>
                </div>
                
                <button type="submit" class="btn btn-primary">Update</button> &nbsp; <button type="reset" class="btn btn-info">Reset</button><br><br>
