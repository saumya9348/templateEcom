    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="content-body">
                <?php
                $cmd1="select * from admin where admin_id=".$_SESSION['admid'];
                $qry1=$conn->query($cmd1);
                foreach($qry1 as $v1){}
                ?>
            <div class="container-fluid mt-3">
                <div class="row">
                <form action="profile_edit_code.php" method="post">
                <?php if(isset($_SESSION['upd_pro_msg'])){ ?>
                <h4><?php echo $_SESSION['upd_pro_msg']; unset($_SESSION['upd_pro_msg']); ?></h4><br>
                <?php } ?>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Your Name</label>
                        <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $v1['admin_name']; ?>" name="nm" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Your Mail</label>
                        <input type="text" class="form-control form-control-lg" id="exampleInputPassword1" value="<?php echo $v1['admin_mail_or_ph']; ?>" name="mlid">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Your UserId</label>
                        <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $v1['adm_user_nm']; ?>" name="unm">
                    </div>
                    <button type="submit" class="btn btn-primary">Update</button> <button type="reset" class="btn btn-danger">Reset</button>
                </form>
                </div>
