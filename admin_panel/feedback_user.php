    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <?php
            $cmd2="select * from user_query uq inner join user_data ud on uq.user_id = ud.user_id";
                ...
                <div class="row">
                    <table class="table">
                        <thead class="thead-dark">
                            ...
                            <th scope="col">Coustmber Massage</th>
                            <th scope="col">Coustmber Mail</th>
                        ...
                        ?>
                            ...
                            <td scope="col"><?php echo $v3['use_name'] ; ?></td>
                            <td scope="col"><?php echo $v3['user_msg'] ; ?></td>
                            <td scope="col"><?php echo $v3['user_mail'] ; ?></td>
                            <td scope="col"><button class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"><a style="color:white;" href="feedback_query_dlt_code.php?id=<?php echo $v3['query_id'] ; ?>"> Delete</a></i></button></td>
