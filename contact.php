		...
		<div class="col-lg-8 col-lg-offset-2">
			...
			<form action="contact_code.php" method="post">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleFormControlInput1" name="nam" placeholder="ex:Harry Xaxlo" required>
				</div>
				<div class="form-group">
					<label for="exampleFormControlInput2">Email address</label>
					<input type="email" class="form-control" id="exampleFormControlInput2" name="mil" placeholder="name@example.com" required>
					<small id="" class="form-text text-muted">We'll never share your email with anyone else.</small>
				</div>
				<div class="form-group">
					<label for="exampleFormControlTextarea3">Message</label>
					<textarea class="form-control" id="exampleFormControlTextarea3" name="msg" rows="3" id="message" placeholder="Type your Message *" required ></textarea><br><br>
					<input type="submit" id="" class="clearfix btn submitbtn" value="Send">
				</div>
			</form>
		</div>
	</div>
